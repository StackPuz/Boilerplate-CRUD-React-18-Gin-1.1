        ...
        <div className="col">
          <div className="col-12"><input id="searchbar_toggle" type="checkbox" />
            ...
            <table className="table table-sm table-striped table-hover">
              <thead>
                <tr>
                  <th className={Util.getSortClass('OrderHeader.id','asc')}>
                    <Link to={Util.getLink(paging,'sort','OrderHeader.id','asc')}>Id</Link>
                  </th>
                  ...
                  <th className={Util.getSortClass('OrderHeader.order_date')}>
                    <Link to={Util.getLink(paging,'sort','OrderHeader.order_date')}>Order Date</Link>
                  </th>
                  <th>Actions</th>
                </tr>
              </thead>
              <tbody>
                ...
                <tr key={index}>
                  ...
                  <td className="d-none d-md-table-cell">{orderHeader.CustomerName}</td>
