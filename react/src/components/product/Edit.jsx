          ...
          <form method="post" onSubmit={edit} encType="multipart/form-data">
            <div className="row">
              ...
              <div className="mb-3 col-md-6 col-lg-4">
                ...
                <a href={`http://localhost:8080/uploads/products/${product.Image ?? '' }`} target="_blank" rel="noreferrer" title={`${product.Image ?? '' }`}><img className="img-item" src={`http://localhost:8080/uploads/products/${product.Image ?? '' }`} /></a>
